...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("group", "View Group Chat activity and shared files", "Session",
               gateway_only=True, aliases=("rooms",), busy_policy="dispatch", desktop="hidden",
               args_hint="[list [page] | <group> [bots|files [query]]]"),
